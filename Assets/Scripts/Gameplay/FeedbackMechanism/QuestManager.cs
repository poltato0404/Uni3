...
//         StartCoroutine(ShowText1(questString[completedQuest]));
//     }
...
//     public void ProceedQuest1(int currentQuestNum)
//     {
//         if (completedQuest < targetQuest)
//         {
...
//             StartCoroutine(ShowText1(currentQuestText));
//             completedQuest++;
//         }
...
//     IEnumerator ShowText1 (string text)
//     {
//         questText.text = "";
